	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-9">
					<form action="<%=path%>/bookInfoUpdate" method="post">
						<input type="hidden" name="id" value="${entity.id }">
						<div class="form-group">
							<label>ISBN号码</label> <input type="text" name="bookISBN" required
								value="${entity.bookISBN }" class="form-control"
								placeholder="请输入图书的ISBN号码">
						</div>
						<div class="form-group">
							<label>书名</label> <input type="text" name="bookName" required
								value="${entity.bookName }" class="form-control"
								placeholder="请输入书名">
						</div>
						<div class="form-group">
							<label>作者</label> <input type="text" name="author" required
								value="${entity.author }" class="form-control"
								placeholder="请输入作者姓名">
						</div>
						<div class="form-group">
							<label>价格</label> <input type="text" name="price" 
								value="${entity.price }" class="form-control" placeholder="请输入价格">
						</div>
						<div class="form-group">
							<label>图书类型编号</label> <input type="number" name="typeId"
								value="${entity.typeId }" class="form-control"
								placeholder="请输入图书类型编号">
						</div>
						<div class="form-group">
							<label>出版社</label> <input type="text" name="publisher" required
								value="${entity.publisher }" class="form-control"
								placeholder="请输入出版社">
						</div>
						
						<p align="center">
							<button type="button" class="btn btn-primary" data-toggle="modal"
									data-target=".bs-example-modal-sm">更新</button>
						</p>
						...
						<div class="modal fade bs-example-modal-sm" tabindex="-1"
									...
									<div class="modal-dialog modal-sm" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">您确认要更新此信息?</div>
